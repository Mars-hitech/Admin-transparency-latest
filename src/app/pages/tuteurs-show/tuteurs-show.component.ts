...
@Component({
  selector: 'ngx-tuteurs-show',
  templateUrl: './tuteurs-show.component.html',
  styleUrls: ['./tuteurs-show.component.scss']
})
export class TuteursShowComponent implements OnInit {
  resultat:any;
  resultat_id:any;
  search:any;
  get_searc:any;
