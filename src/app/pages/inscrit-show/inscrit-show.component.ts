...
@Component({
  selector: 'ngx-inscrit-show',
  templateUrl: './inscrit-show.component.html',
  styleUrls: ['./inscrit-show.component.scss']
})
export class InscritShowComponent implements OnInit {
