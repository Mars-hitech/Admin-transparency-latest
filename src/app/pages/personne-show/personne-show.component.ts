...
@Component({
  selector: 'ngx-personne-show',
  templateUrl: './personne-show.component.html',
  styleUrls: ['./personne-show.component.scss']
})
export class PersonneShowComponent implements OnInit {
  resultat:any;
  resultat_id:any;
  search:any;
  get_searc:any;
