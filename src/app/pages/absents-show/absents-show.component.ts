...
@Component({
  selector: 'ngx-absents-show',
  templateUrl: './absents-show.component.html',
  styleUrls: ['./absents-show.component.scss']
})
export class AbsentsShowComponent implements OnInit {
